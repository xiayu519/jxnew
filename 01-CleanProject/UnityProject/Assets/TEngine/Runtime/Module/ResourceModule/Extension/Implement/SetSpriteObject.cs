...
namespace TEngine
{
    ...
    public class SetSpriteObject : ISetAssetObject
    {
        ...
        public static SetSpriteObject Create(Image image, string location, bool setNativeSize = false, Action<Image> callback = null, CancellationToken cancellationToken = default, string packageName = "")
        {
            SetSpriteObject item = MemoryPool.Acquire<SetSpriteObject>();
            item._image = image;
            item._setNativeSize = setNativeSize;
            item.Location = location;
            item.PackageName = packageName ?? string.Empty;
        ...
        public static SetSpriteObject Create(SpriteRenderer spriteRenderer, string location, Action<SpriteRenderer> callback = null, CancellationToken cancellationToken = default, string packageName = "")
        {
            SetSpriteObject item = MemoryPool.Acquire<SetSpriteObject>();
