...
namespace TEngine
{
    ...
    public class AudioCategory
    {
            ...
            string packageName = "")
        {
            ...
            {
                // An asynchronously loading agent has no AudioData yet, but
                // it is not free. Reusing it here replaces its pending clip
                // before the first sound can start.
            ...
            if (freeChannel >= 0)
            {
                ...
                {
                    AudioAgents[freeChannel] = AudioAgent.Create(
                        path,
                        bAsync,
                        this,
                        bInPool,
