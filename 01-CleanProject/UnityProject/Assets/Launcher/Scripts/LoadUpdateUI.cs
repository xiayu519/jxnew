...
namespace Launcher
{
    ...
    public class LoadUpdateUI : UIBase
    {
        ...
        private Image m_imgProgressFill;
        ...
        protected override void ScriptGenerator()
        {
            ...
            m_imgProgressFill = FindChildComponent<Image>("m_rectProgressPanel/m_imgProgressFill");
            m_textUpdateDesc = FindChildComponent<Text>("m_rectProgressPanel/m_textUpdateDesc");
        ...
        {
            m_imgProgressFill.gameObject.SetActive(true);
            m_imgProgressFill.fillAmount = Mathf.Clamp01(progress);
        }

        internal void RefreshDescription(object description)
        {
            if (m_textUpdateDesc != null)
                m_textUpdateDesc.text = description?.ToString() ?? string.Empty;
        }
