...
namespace GameLogic
{
    ...
    public sealed partial class UIModule : Singleton<UIModule>, IUpdate
    {
        ...
        private static IWindowDescriptorResolver _windowDescriptorResolver =
            WindowAttributeDescriptorResolver.Instance;

        public static IWindowDescriptorResolver WindowDescriptorResolver
        {
            get => _windowDescriptorResolver;
            set => _windowDescriptorResolver = value ??
                WindowAttributeDescriptorResolver.Instance;
        }
       ...
       /// <summary>
        ...
        private static void InitializeWindow(
            ...
            UIWindow window)
        {
            IWindowDescriptorResolver resolver =
                WindowDescriptorResolver;
            if (!resolver.TryResolve(
                    type,
                    out WindowDescriptor descriptor))
            {
                WindowAttributeDescriptorResolver.Instance.TryResolve(
                    type,
                    out descriptor);
            }
            window.Init(
